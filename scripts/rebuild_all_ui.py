...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* ========================================================
       TOP STICKY NAVBAR (CLEAN BRAND + CENTER-TO-RIGHT LINKS)
       ======================================================== */
    .top-navbar {
      position: sticky;
      top: 0;
    ...
    .hero-claim strong { color: #FFFFFF; }
    ...
    .beat-card.problem { border-left-color: #EF4444; }
    .beat-card.catch { border-left-color: #F59E0B; }
    .beat-card.result { border-left-color: #10B981; }
    ...
    .beat-header.catch { color: #B45309; }
    .beat-header.result { color: #047857; }
    ...
    .terminal-line.tool { color: #F59E0B; }
    .terminal-line.res { color: #10B981; }
    ...
    @media (max-width: 768px) {
      ...
      /* 1. Prevent Horizontal Jitter: Force Vertical Scroll Animations */
      .reveal-left,
      .reveal-right {
      ...
      /* 2. Top Sticky Mobile Bar: Sleek Brand + Smooth Swipeable Links */
      .top-navbar {
        padding: 10px 16px;
        flex-direction: column;
        align-items: stretch;
...
<body>
  ...
  <div class="site-wrapper">
    ...
    <!-- Top Sticky Navbar (Centered Brand + Right Navigation) -->
      ...
      <div class="footer-container">
        <div class="footer-brand">
          ...
          <div class="social-row">
            <a href="https://github.com/24pwai0015-max" target="_blank" rel="noopener" class="social-btn" title="GitHub"><i class="fa-brands fa-github"></i></a>
            <a href="https://linkedin.com" target="_blank" rel="noopener" class="social-btn" title="LinkedIn"><i class="fa-brands fa-linkedin-in"></i></a>
            <a href="mailto:24pwai0015@uetpeshawar.edu.pk" class="social-btn" title="Email"><i class="fa-solid fa-envelope"></i></a>
          </div>
        </div>
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media (max-width: 768px) {
      .paper-wrapper { padding: 12px 10px 60px; }
      .paper-sheet { padding: 24px 16px; border-radius: var(--radius-md); }
      .paper-title { font-size: 1.65rem; line-height: 1.25; margin-bottom: 18px; }
      .charts-grid { grid-template-columns: 1fr; gap: 16px; }
      .author-card { flex-direction: column; text-align: center; padding: 18px 14px; gap: 14px; }
      .author-card-left { flex-direction: column; align-items: center; text-align: center; gap: 12px; }
      .author-details { text-align: center; }
      .btn-download-pdf-hero { width: 100%; justify-content: center; font-size: 0.88rem; }
      .paper-nav { flex-direction: column; gap: 10px; padding: 12px 14px; top: 8px; margin-bottom: 20px; }
      .nav-left-btns { flex-direction: column; width: 100%; gap: 8px; }
      .nav-right-meta { justify-content: space-between; width: 100%; }
      .back-btn, .pdf-download-nav-btn { width: 100%; justify-content: center; font-size: 0.85rem; padding: 8px 14px; }
      .table-container { overflow-x: auto; -webkit-overflow-scrolling: touch; margin: 18px 0; }
      .abstract-box { padding: 18px 14px; }
